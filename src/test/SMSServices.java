 ...
 *
 */
public String sendDNTestA(String username, String password , String message , String senderId, String mobileNumber, String secureKey, String templateid){
...
//
HttpPost post=new HttpPost("https://api.unitiapro.com/dntesta");
...
public String sendDNTestB(String username, String password , String message , String senderId, String mobileNumber, String secureKey, String templateid){
String responseString = "";
SSLSocketFactory sf=null;
SSLContext context=null;
String encryptedPassword=null;
...
client.getConnectionManager().getSchemeRegistry().register(scheme);
//
HttpPost post=new HttpPost("https://api.unitiapro.com/dntestb");
 ...
 * @param username : Department Login User Name
 * @param password : Department Login Password
 * @param message : Unicode Message e.g. 'рд╡рд┐рдрд╛рд╕ рдрдгрд┐ рдкрерд░рдрдд рд╕рдрдрдгрди рдрердрджрерд░ рдордзрердпре рд╕ре
 * @param senderId : Department allocated SenderID
 * @param mobileNumber : Bulk Mobile Number with comma separated e.g. '99XXXXXXX,99XXXXXXXX'
 * @param secureKey : Department key generated by login to services portal
 * @return {@link String} response from Mobile Seva Gateway e.g. '402,MsgID = 150620161466003974245msdgsms'
 ...
 *</namevaluepair></namevaluepair></namevaluepair></namevaluepair></namevaluepair></namevaluepair></p><p> Use only in case of OTP related mess
 ...
 * @param message e.g. 'рд╡рд┐рдрд╛рд╕ рдрдгрд┐ рдкрерд░рдрдд рд╕рдрдрдгрди рдрердрджрерд░ рдордзрердпре рд╕рерд╡рд╛рдрдд рдрд
